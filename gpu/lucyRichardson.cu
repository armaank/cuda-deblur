  ...
  */
void kernel_updateUnderlyingImg(const float *c, const float *g, const float *g_m, float *f, float *tmp1, float *tmp2, const uint W, const uint H)
{
...
createMirroredKernel(double *g, double *g_m);
...
__global__
void kernel_internalMemcpy(float *to,const float *from, const uint W, const uint H)
{
